                                       ...
                                       vec3f & boardNormal )
{
    ...
    */
    ...
    int main()
    {
        ...
        RigidBody rigidBody;
        printf( "calculating ellipsoid inertia tensor...\n" );
        CalculateEllipsoidInertiaTensor( rigidBody.mass, 1,0.5f,1, rigidBody.inertiaTensor, rigidBody.inverseInertiaTensor );
